...
num_samples=100       #Number of samples to be generated for each value of n

# file_to_be_deleted="data_report_tables/data_table_1.csv"        #Uncomment this for data related to Table 1,2
file_to_be_deleted="data_report_tables/data_table_4.csv"        #Uncomment this for data related to Table 3
